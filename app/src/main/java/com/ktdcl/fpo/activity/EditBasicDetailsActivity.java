...
public class EditBasicDetailsActivity  extends AppCompatActivity {
    private static final String TAG = "EditBasicDetailsActivit";
    private View mView;
    ...
    private FarmerModel farmerModelData;
    @Override
    ...
    private void initData() {
        farmerModelData = getIntent().getParcelableExtra("DATA");
        ...
        ArrayAdapter aa = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, mQualificationList);
        ...
        ArrayAdapter memAdapter = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, mMemberList);
        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        ...
        ArrayAdapter mainIncomeAdapter = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, sourceOfIncomes);
        ...
        ArrayAdapter secondAdapter = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, secondaryOfIncomes);
    ...
    private void initCropData(){
        for(int i=0;i<views.length; i++)
        {
            ...
            ArrayAdapter cropAdapter = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, cropList);
        ...
        ArrayAdapter num = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, numbers);
    ...
    private void initListeners() {
        mButtonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.select_dist), Toast.LENGTH_LONG).show();
                    return;
                }
                if(taluk!=null)
                {
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.select_taluk), Toast.LENGTH_LONG).show();
                    return;
                }
                if(village!=null)
                {
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.select_village), Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.enter_name), Toast.LENGTH_LONG).show();
                    editTextFarmerName.setError(EditBasicDetailsActivity.this.getString(R.string.enter_name));
                    return;
                }
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.enter_father_name), Toast.LENGTH_LONG).show();
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.enter_aadhar), Toast.LENGTH_LONG).show();
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.enter_phone), Toast.LENGTH_LONG).show();
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.enter_age), Toast.LENGTH_LONG).show();
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.select_membership), Toast.LENGTH_LONG).show();
                    return;
                }
                if(qual!=null)
                {
                ...
                {
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.select_education), Toast.LENGTH_LONG).show();
                    return;
                }
                ...
                if(mainIncome!=null)
                {
                    ...
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.select_main_income), Toast.LENGTH_LONG).show();
                }
                ...
                if(secondIncome!=null)
                {
                    ...
                    Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.select_second_income), Toast.LENGTH_LONG).show();
                }
                ...
                fpoAppModel.setLandDetailsModelList(landDetailsModelList);
                     ...
                     */
                Intent intent = new Intent(EditBasicDetailsActivity.this, CropVetToolsActivity.class);
                Gson gson = new Gson();
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int position, long l) {
                if(position!=0)
                {
                    if(mainIncome.equalsIgnoreCase(secondaryOfIncomes.get(position))){
                        Toast.makeText(EditBasicDetailsActivity.this, getString(R.string.both_income_same), Toast.LENGTH_LONG).show();
                        spSecondarySourceIncome.setSelection(0);
                    }
                    else {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        menu.getItem(0).setTitle(AppUtils.getVersion(EditBasicDetailsActivity.this));
        return true;
    }
        ...
        listCall.enqueue(new Callback<List<TalukModel>>() {
            ...
            public void onResponse(Call<List<TalukModel>> call, Response<List<TalukModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    mTalukNames.add(EditBasicDetailsActivity.this.getString(R.string.Select_Taluk));
            ...
            public void onFailure(Call<List<TalukModel>> call, Throwable t) {
                progressbarLyt.setVisibility(View.GONE);
                Toast.makeText(EditBasicDetailsActivity.this, R.string.something_wrong, Toast.LENGTH_LONG).show();
            }
        });
    }
        ...
        listCall.enqueue(new Callback<List<VillageModel>>() {
            ...
            public void onResponse(Call<List<VillageModel>> call, Response<List<VillageModel>> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    mTandaNames.add(EditBasicDetailsActivity.this.getString(R.string.Select_Tanda));
                    if (villageModelList != null && villageModelList.size() > 0) {
                        ...
                        ArrayAdapter aa = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, mTandaNames);
                        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
    ...
    private boolean checkInternet() {
        ConnectivityManager mgr = (ConnectivityManager) EditBasicDetailsActivity.this.getSystemService(Context.CONNECTIVITY_SERVICE);
            ...
            listCall.enqueue(new Callback<List<DistrictModel>>() {
                ...
                public void onResponse(Call<List<DistrictModel>> call, Response<List<DistrictModel>> response) {
                    ...
                    if (response.isSuccessful()) {
                        ...
                        mDistrictNamesList.add(EditBasicDetailsActivity.this.getString(R.string.Select_District));
                        for (int i = 0; i < districtModelList.size(); i++) {
                            mDistrictNamesList.add(districtModelList.get(i).getDist_name());
                        }
                        ArrayAdapter aa = new ArrayAdapter(EditBasicDetailsActivity.this, R.layout.spinner_item, mDistrictNamesList);
                        aa.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);

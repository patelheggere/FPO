...
public class FarmerModel implements Parcelable {
    ...
    public FarmerModel(String name, String fruitsNo, String PAN, String religion, String caste, String mainProfession, String subProfession, String noGents, String noLadies, String noChildren, String fname, String workingInLand, String noOfEducated, String memOfLocalOrg, String aadha, String cropIncome, String agWorkIncome, String nonAgWorkIncome, String dairyIncome, String liveStockIncome, String sericultureIncome, String phone, String govtDevelopmentIncome, String cropProcessingIncome, String otherIncome, String email, String isThereBankAcct, String bankName, String village, String taluk, String dist, String qualification, String tanda_resident, String gp, String otherPlace, String dob, String gender, String kottigeArea, String kottigeRemarks, String mainIncomeSource, String secondIncomeSource, String ceo_id, String age, List<LandDetailsModel> landDetailsModelList, List<CropDetailsModel> cropDetailsModelList, List<AgToolsModel> agToolsModelList, List<VetDetailsModel> vetDetailsModelList, List<MarketDetailsModel> marketDetailsModelList, List<AgToolsPurchaseModel> agToolsPurchaseModelList, List<CropInsuranceModel> cropInsuranceModels, String soilTested, String soilTestedYear, String didSoilTestImplemented, String advanceSeedsUsed, String advancedIrrigation, String pestControlled, String areYouVisitingAgUniveese, String ifYesWhom, String ictInstalled, String dryingYard, String model, String capacity, String aadharPhoto, String photo, String sl_no) {
        this.name = name;
    ...
    protected FarmerModel(Parcel in) {
        ...
        ceo_id = in.readString();
        age = in.readString();
        landDetailsModelList = in.createTypedArrayList(LandDetailsModel.CREATOR);
        cropDetailsModelList = in.createTypedArrayList(CropDetailsModel.CREATOR);
        agToolsModelList = in.createTypedArrayList(AgToolsModel.CREATOR);
        vetDetailsModelList = in.createTypedArrayList(VetDetailsModel.CREATOR);
        marketDetailsModelList = in.createTypedArrayList(MarketDetailsModel.CREATOR);
        agToolsPurchaseModelList = in.createTypedArrayList(AgToolsPurchaseModel.CREATOR);
        cropInsuranceModels = in.createTypedArrayList(CropInsuranceModel.CREATOR);
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(ceo_id);
        dest.writeString(age);
        dest.writeTypedList(landDetailsModelList);
        dest.writeTypedList(cropDetailsModelList);
        dest.writeTypedList(agToolsModelList);
        dest.writeTypedList(vetDetailsModelList);
        dest.writeTypedList(marketDetailsModelList);
        dest.writeTypedList(agToolsPurchaseModelList);
        dest.writeTypedList(cropInsuranceModels);
